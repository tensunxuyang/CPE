<template>
  <div class="app-container wifi5G">
    <div class="tab" id="tab">
      <div class="choseTab" @click="choseTab('0')">5G</div>
      ...
      getData(data){
        ...
        getDataInfo(data).then((res) => {
          if (this.chosetempTab == '0') {
            ...
            this.cardListTemp[0].list[1].value = Object.keys(this.WorkModelist[1])[res.value.WorkMode - 1];
            ...
            this.cardListTemp[0].list[6].value = this.Bandwidth5G[res.value.Bandwidth];
...
<style>
  ...
  .wifi5G .card-itemTitle {
    font-size: 14px;
    height: 30px;
    font-weight: bold;
  }

  .wifi5G .card-itemTime {
    color: #bfcbd9;
  }
