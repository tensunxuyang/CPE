<template>
  <div class="app-container ipmacBind">
    <div class="tab" id="tab">
      <div class="choseTab" @click="choseTab('0')">IP MAC绑定</div>
    </div>
        ...
        <el-col :span="24" class="card-box" >
          <el-card>
            ...
            <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="目标地址" prop="roleKey" :show-overflow-tooltip="true" width="100" />
              <el-table-column label="MAC地址" prop="roleKey" :show-overflow-tooltip="true" width="150" />
