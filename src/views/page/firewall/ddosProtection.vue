<template>
  <div class="app-container ddosProtection">
    <div class="tab" id="tab">
      <div class="choseTab" @click="choseTab('0')">DDOS防护</div>
    </div>
...
<style>
  ...
  .ddosProtection .card-box{
    margin-top: 20px;
  }
  .ddosProtection .widthValue{
      width: 30%;
    }
